//package com.lian.base.web.config;
//
...
//import com.kd.gaea.common.exception.CommonException;
//import com.kt.data.base.common.exception.ExtRuntimeException;
//import com.kt.data.base.common.model.GlobalResponse;
...
//        ExtRuntimeException extRuntimeException = CommonException.UNKNOWN.runtimeException();
//        return new ResponseEntity<>(GlobalResponse.fail(extRuntimeException.getCode(), extRuntimeException.getMessage(),
...
//        Throwable rootCause = ExceptionUtil.getRootCause(e);
//        log.error(ExceptionUtil.getMessage(rootCause), rootCause);
//        return new ResponseEntity<>(GlobalResponse.fail(e.getStatusText(), ExceptionUtil.getSimpleMessage(rootCause),
//            (String) httpServletRequest.getAttribute(GlobalResponse.LOG_MARK_NAME)),
...
//        log.error(ExceptionUtil.getMessage(rootCause), rootCause);
//        //不能将异常详细信息返回前端，为了安全需要重新包装
//        ExtRuntimeException extRuntimeException = CommonException.HTTP_NOT_FOUND.runtimeException();
//        return new ResponseEntity<>(GlobalResponse.fail(extRuntimeException.getCode(), extRuntimeException.getMessage(),
//            (String) httpServletRequest.getAttribute(GlobalResponse.LOG_MARK_NAME)),
//            HttpStatus.valueOf(extRuntimeException.getStatus()));
//    }
...
//        log.error(ExceptionUtil.getMessage(rootCause), rootCause);
//        //不能将异常详细信息返回前端，为了安全需要重新包装
//        ExtRuntimeException extRuntimeException = CommonException.PARAM_VALID_ERROR.runtimeException(e.getMessage());
//        return new ResponseEntity<>(GlobalResponse.fail(extRuntimeException.getCode(), extRuntimeException.getMessage(),
//            (String) httpServletRequest.getAttribute(GlobalResponse.LOG_MARK_NAME)),
//            HttpStatus.valueOf(extRuntimeException.getStatus()));
//    }
...
//        }
//        return new ResponseEntity<>(GlobalResponse.fail(extRuntimeException.getCode(), extRuntimeException.getMessage(),
//            (String) httpServletRequest.getAttribute(GlobalResponse.LOG_MARK_NAME)), HttpStatus.INTERNAL_SERVER_ERROR);
//    }
//
//    /**
...
//        Throwable rootCause = ExceptionUtil.getRootCause(e);
//        log.error(ExceptionUtil.getMessage(rootCause), rootCause);
//        return new ResponseEntity<>(GlobalResponse.fail(e.getCode(), e.getMessage(), e.getErrorData(),
//            (String) httpServletRequest.getAttribute(GlobalResponse.LOG_MARK_NAME)), HttpStatus.valueOf(e.getStatus()));
//    }
//
//
//    /**
...
//            }
//
//            if (ObjectUtil.isNotEmpty(apiModelProperty)) {
...
//        }
//        return new ResponseEntity<>(GlobalResponse.fail("code.undefined", builder,
//            (String) httpServletRequest.getAttribute(GlobalResponse.LOG_MARK_NAME)), HttpStatus.BAD_REQUEST);
//    }
//}
